-- Fix Transaction Statistics Function
-- This function combines data from both points_transactions and transactions tables

-- Function to get comprehensive transaction statistics for dashboard
