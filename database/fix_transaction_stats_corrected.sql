-- Fix Transaction Analytics - Corrected Version
-- This version handles the column name issue

-- First, let's check what columns actually exist in points_transactions
